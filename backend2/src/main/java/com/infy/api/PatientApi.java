...
public class PatientApi {
 ...
    
    @PreAuthorize("hasRole('PATIENT')")
    @GetMapping("/appointments/rules")
    @Operation(summary = "Get Admin Rules")
    public ResponseEntity<AdminDTO> getRules() throws InfyHospitalException
    {
        AdminDTO rules=patientService.getBookingRules();
 ...
    {
        Long patientId = getLoggedInPatientId();
        PrescriptionDTO dto=patientService.getPatientPrescription(patientId, appointmentId);
