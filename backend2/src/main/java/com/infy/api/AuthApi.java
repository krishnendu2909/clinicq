...
public class AuthApi {
 ...
        
        String successMessage=env.getProperty("API.EMAIL_TOKEN_SUCCESS");
        
 ...
    public ResponseEntity<String> verifyToken(@RequestParam String token) throws InfyHospitalException
    {
