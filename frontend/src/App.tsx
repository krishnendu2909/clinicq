        ...
        <div className="row g-4 mb-5 justify-content-center">
          ...
          {[

            {
              ...
              action: () => { setLoginRole('Admin'); window.location.href = '/admin-login'; }
...

            {
              ...
              action: () => window.location.href = '/patient-login'
...

            {
              ...
              action: () => window.location.href = '/doctor-login'
...

            {
              ...
              action: () => window.location.href = '/receptionist-login'
...
const PatientPortalWrapper: React.FC = () => {
  ...
  return (
    ...
    <>
      ...
      {patientSubView === 'my' && <MyAppointments onNavigate={setPatientSubView} onReturnHome={() => window.location.href = '/'} />}
...
// --- Main App Component (With Explicit React Routing Paths Enabled) ---

function App() {

  const [, setLoginRole] = useState('');

  const [, setIsAdminFormOpen] = useState(false);

  return (

  <Router>

    <Routes> {/* Basic Context Root Navigation Paths */}
      ...
      <Route path="/patient-register" element={
        ...
        <PatientRegister onRegisterSuccess={() => {
        ...
        onReturnToLogin={() => window.location.href = '/patient-login'}
      ...
      {/* Dashboard View Layout Managers */}

      <Route path="/admin" element={<AdminDashboard onToggleForm={(isOpen) => setIsAdminFormOpen(isOpen)} />} />
      ...
      {/* Wildcard Fallback redirection to home screen path */}
